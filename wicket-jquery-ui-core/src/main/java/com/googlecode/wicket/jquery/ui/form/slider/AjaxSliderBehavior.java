...
public abstract class AjaxSliderBehavior extends SliderBehavior implements IJQueryAjaxAware
{
	...
	//private final FormComponent<?> input; //TODO to remove

	public AjaxSliderBehavior(String selector /*, FormComponent<?> input */)
	{
		super(selector);
	...
	public AjaxSliderBehavior(String selector, /* FormComponent<?> input, */ Options options)
	{
